			...
			<div className="mx-auto max-w-295 px-8">
				<div className="grid grid-cols-1 items-center gap-8 rounded-[18px] border border-rule bg-paper p-6 md:grid-cols-[1.1fr_1fr] md:p-9">
					<div>
						...
						<h3 className="mt-3.5 mb-3.5 font-display font-medium text-[38px] leading-[1.05] tracking-tight">
							Ask <em className="text-accent italic">Parm</em>, the chatbot.
						</h3>
						<p className="max-w-[38ch] text-[15px] text-ink-soft leading-[1.6]">
